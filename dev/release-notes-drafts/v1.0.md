...
- #484 by **@AugusteBalas** - fix: handle generic fixers that return entries without `removed` key
- #485 by **@ryexLLC** - fix: handle framework dataclass cache + synthetic deferred loop
